...
here::i_am("code/integrative/01_cytokine_metabolite_correlations.R")
...
dir.create(here::here("data/processed/integrative/cytokine_metabolite_correlations"), recursive = TRUE, showWarnings = FALSE)
...
readr::write_csv(
  ...
  here::here("data/processed/integrative/cytokine_metabolite_correlations/matched sacrifice cytokine metabolite observations.csv"),
  na = "N/A"
)
...
readr::write_csv(
  ...
  here::here("data/processed/integrative/cytokine_metabolite_correlations/pearson sacrifice cytokine metabolite correlations.csv"),
  na = "N/A"
)

readr::write_csv(
  spearman_correlations,
  here::here("data/processed/integrative/cytokine_metabolite_correlations/spearman sacrifice cytokine metabolite correlations.csv"),
  na = "N/A"
)
