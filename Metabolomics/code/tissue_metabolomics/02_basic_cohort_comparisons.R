...
here::i_am("code/tissue_metabolomics/02_basic_cohort_comparisons.R")
...
dir.create(here::here("data/processed/tissue_metabolomics/cohort_comparisons"), recursive = TRUE, showWarnings = FALSE)
dir.create(here::here("data/processed/tissue_metabolomics/pca"), recursive = TRUE, showWarnings = FALSE)
dir.create(here::here("plots/tissue_metabolomics/heatmaps"), recursive = TRUE, showWarnings = FALSE)
dir.create(here::here("plots/tissue_metabolomics/pca"), recursive = TRUE, showWarnings = FALSE)
...
readr::write_csv(
  ...
  here::here("data/processed/tissue_metabolomics/cohort_comparisons/old mouse sample-level median adjusted ion counts.csv")
)

readr::write_csv(
  old_mouse_diet_ttest,
  here::here("data/processed/tissue_metabolomics/cohort_comparisons/old mice inulin vs control t test median adjusted ion count.csv")
)
...
for (current_tissue in unique(old_mouse_heatmap_data$tissue)) {
  ...
  pdf(
    here::here("plots/tissue_metabolomics/heatmaps", paste0("old mice ", current_tissue, " CD vs ID z score heatmap.pdf")),
    width = 9,
    height = 12
  )
...
for (current_tissue in unique(all_group_sample_abundance$tissue)) {
  ...
  ggsave(
    filename = here::here("plots/tissue_metabolomics/pca", paste0(current_tissue, " PCA all experimental groups.pdf")),
    plot = current_plot,
    width = 8,
    height = 6
  )
...
readr::write_csv(
  ...
  here::here("data/processed/tissue_metabolomics/pca/all group PCA scores.csv")
)

readr::write_csv(
  bind_rows(all_group_pca_loadings),
  here::here("data/processed/tissue_metabolomics/pca/all group PCA loadings.csv")
)

readr::write_csv(
  bind_rows(all_group_pca_variance),
  here::here("data/processed/tissue_metabolomics/pca/all group PCA variance explained.csv")
)
...
for (current_tissue in unique(old_mouse_sample_abundance$tissue)) {
  ...
  ggsave(
    filename = here::here("plots/tissue_metabolomics/pca", paste0(current_tissue, " PCA old mice only.pdf")),
    plot = current_plot,
    width = 8,
    height = 6
  )
...
readr::write_csv(
  ...
  here::here("data/processed/tissue_metabolomics/pca/old mouse PCA scores.csv")
)

readr::write_csv(
  bind_rows(old_mouse_pca_loadings),
  here::here("data/processed/tissue_metabolomics/pca/old mouse PCA loadings.csv")
)

readr::write_csv(
  bind_rows(old_mouse_pca_variance),
  here::here("data/processed/tissue_metabolomics/pca/old mouse PCA variance explained.csv")
)
...
readr::write_csv(
  ...
  here::here("data/processed/tissue_metabolomics/pca/old mouse PCA metabolite contributions.csv")
)
...
for (current_tissue in unique(old_mouse_top10_pca_metabolites$tissue)) {
  ...
  ggsave(
    filename = here::here("plots/tissue_metabolomics/pca", paste0(current_tissue, " old mouse PC1 top 10 metabolite contributions.pdf")),
    plot = current_plot,
    width = 8,
    height = 6
  )
